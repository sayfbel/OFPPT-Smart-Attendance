            ...
            <div className={`flex gap-6 overflow-x-auto ista-scrollbar pb-6 pt-2 ${isRtl ? 'flex-row-reverse' : ''}`}>
                {availableGroups.map((grp) => (
                    <div
                        ...
                        className={`min-w-[280px] flex-shrink-0 p-8 rounded-3xl border divisions-card group cursor-pointer relative overflow-hidden flex flex-col ${selectedGroup === grp.id
                            ? 'divisions-card-selected'
                    ...
                    >
                        <div className={`flex items-center justify-between mb-6 relative z-10 ${isRtl ? 'flex-row-reverse' : ''}`}>
                            <div className={`w-12 h-12 rounded-2xl flex items-center justify-center border transition-all ${selectedGroup === grp.id ? 'divisions-card-icon-selected' : 'bg-slate-50 border-slate-100 text-slate-400'
                                }`}>
                        ...
                        <div className={`mt-auto pt-6 border-t border-slate-50 flex items-center justify-between relative z-10 ${isRtl ? 'flex-row-reverse' : ''}`}>
                            ...
                            <div className={`flex items-center gap-2 ${isRtl ? 'flex-row-reverse' : ''}`}>
                                <div className={`w-1.5 h-1.5 rounded-full ${selectedGroup === grp.id ? 'divisions-card-dot-selected animate-pulse' : 'bg-slate-200'}`}></div>
