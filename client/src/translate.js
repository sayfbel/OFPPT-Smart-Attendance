...
const resources = {
    fr: {
        translation: {
            ...
            filiere: {
                ...
                add_button: 'AJOUTER UNE FILIÈRE',
                new_unit: 'Nouvelle Unité',
                register_specialty: 'Enregistrer une spécialité',
                active_training: 'Formation Active',
                update_ref: 'Mise à jour du Réf.',
                label: 'Intitulé Filière',
                placeholder: 'Saisissez le nouvel intitulé...',
                save: 'ENREGISTRER',
                no_ref: 'AUCUN RÉFÉRENTIEL IDENTIFIÉ',
                modal_new: 'Nouvelle Filière',
                modal_edit: 'Édition Filière',
                modal_admin: 'ADMINISTRATION DU RÉFÉRENTIEL',
                modal_label: 'INTITULÉ OFFICIEL DE LA FILIÈRE',
                modal_placeholder: 'Saissisez le nom de la filière...',
                modal_save: 'ENREGISTRER LA FILIÈRE',
                modal_update: 'METTRE À JOUR LE RÉFÉRENTIEL',
                sync: 'SYNCHRONISATION...',
                system_tag: 'SYSTEME DE RÉFÉRENTIEL - OFPPT ISTA',
                delete_title: 'Supression Critique',
                delete_msg: 'Cette action purgera définitivement la filière du référentiel. Les groupes associés perdront leur affiliation.',
            },
            salles: {
                title: 'Salles',
                subtitle: 'GESTION DU PARC IMMOBILIER ET ESPACES DE FORMATION',
                search_placeholder: 'RECHERCHER UNE SALLE...',
                add_button: 'AJOUTER UNE SALLE',
                new_room: 'Nouvel Espace',
                register_room: 'Enregistrer une salle',
                available: 'Salle Disponible',
                update_room: 'Mise à jour de l\'espace',
                label: 'Nom de la salle',
                placeholder: 'Saisissez le nom de la salle...',
                save: 'ENREGISTRER',
                no_rooms: 'AUCUNE SALLE IDENTIFIÉE',
                modal_new: 'Nouvelle Salle',
                modal_edit: 'Édition Salle',
                modal_admin: 'GESTION DES LOCAUX',
                modal_label: 'NOM OFFICIEL DE LA SALLE',
                modal_placeholder: 'Saissisez le nom de la salle...',
                modal_save: 'ENREGISTRER LA SALLE',
                modal_update: 'METTRE À JOUR LA SALLE',
            },
            absence_registry: {
                title: "REGISTRE D'ABSENCES",
                subtitle: "GESTION DISCIPLINAIRE ET JUSTIFICATIONS",
                search: "RECHERCHER...",
                filter_status: "TOUS LES ÉTATS",
                filter_absences: "ABSENCES",
                filter_lates: "RETARDS",
                filter_presences: "PRÉSENCES",
                filter_all_justif: "TOUTES JUSTIF.",
                filter_justified: "JUSTIFIÉES",
                filter_not_justified: "NON JUSTIFIÉES",
                filter_pending: "EN ATTENTE",
                col_student: "STAGIAIRE",
                col_session: "SESSION / DATE",
                col_status: "ÉTAT",
                col_reported_by: "SIGNALÉ PAR",
                col_actions: "ACTIONS",
                btn_justify: "JUSTIFIER",
                btn_cancel_justif: "ANNULER JUSTIF.",
                btn_sanction: "SANCTIONNER",
                status_absence: "ABSENCE",
                status_late: "RETARD",
                status_present: "PRÉSENT",
                status_justified: "JUSTIFIÉ",
                status_not_justified: "NON JUSTIFIÉ",
                sync: "Synchronisation du Registre...",
                delete_title: "Supression Critique",
                delete_msg: "Cette action purgera définitivement la filière du référentiel.",
                sync_error: "Erreur lors de la récupération du registre",
                justif_success: "Absence justifiée avec succès",
                justif_removed: "Justification retirée",
            ...
            profile: {
                title: "MON PROFIL",
                subtitle: "PARAMÈTRES DU COMPTE ET SÉCURITÉ",
                ...
                password_match_error: "Les nouveaux mots de passe ne correspondent pas",
                password_subtitle: "RENFORCEZ LA PROTECTION DE VOTRE ACCÈS",
                password_hint: "Utilisation recommandée de 8 caractères minimum",
                sync: "MISE À JOUR...",
            },
            header: {
            ...
            accounts: {
                ...
                header_subtitle: 'GESTION DES UTILISATEURS ISTA',
                all_streams: 'TOUTES LES FILIÈRES',
                add_user: 'AJOUTER UN UTILISATEUR',
                add_member: 'AJOUTER UN MEMBRE',
                stream_label: 'Filière',
                search_placeholder: 'RECHERCHER UN STAGIAIRE (NOM, ID, EMAIL)...',
                search_stg_placeholder: 'RECHERCHER UN NOM OU ID...',
                search_staff_placeholder: 'RECHERCHER STAFF...',
                total_students: 'TOTAL STAGIAIRES',
                students_section: 'STAGIAIRES',
                students_list: 'LISTE DES STAGIAIRES',
                formateurs_section: 'FORMATEURS',
                formateurs_team: 'ÉQUIPE PÉDAGOGIQUE ET STAFF',
                col_id: 'ID',
                ...
                no_students_found: 'AUCUN STAGIAIRE TROUVÉ',
                no_staff_found: 'AUCUN STAFF TROUVÉ',
            ...
            reports: {
                ...
                export_subtitle: 'Modèle professionnel (version modernisée)',
                export_salle: 'Salle',
                export_time: 'Horaire',
                export_total: 'Nombre total',
                export_absents_count: 'Absents',
                export_num: 'N°',
                export_btn: 'EXPORTER',
            ...
            penalty_decision: {
                ...
                select_sanction: 'SÉLECTION DE LA SANCTION',
                reason_report: 'MOTIF / RAPPORT',
                reason_placeholder: 'DÉTAILLEZ LES MOTIFS ICI...',
                validate: 'VALIDER LA SANCTION'
            },
            datepicker: {
    ...
    ar: {
        translation: {
            ...
            filiere: {
                title: 'الشعب',
                subtitle: 'إدارة المرجع الخاص بتخصصات ISTA',
                search_placeholder: 'البحث عن تخصص...',
                add_button: 'إضافة شعبة',
                new_unit: 'وحدة جديدة',
                register_specialty: 'تسجيل تخصص',
                active_training: 'تكوين نشط',
                update_ref: 'تحديث المرجع',
                label: 'اسم الشعبة',
                placeholder: 'أدخل الاسم الجديد...',
                save: 'حفظ',
                no_ref: 'لم يتم العثور على أي مرجع',
                modal_new: 'شعبة جديدة',
                modal_edit: 'تعديل الشعبة',
                modal_admin: 'إدارة المرجع',
                modal_label: 'الاسم الرسمي للشعبة',
                modal_placeholder: 'أدخل اسم الشعبة...',
                modal_save: 'حفظ الشعبة',
                modal_update: 'تحديث المرجع',
                sync: 'جاري المزامنة...',
                system_tag: 'نظام المراجع - OFPPT ISTA',
                delete_title: 'حذف حرج',
                delete_msg: 'سيؤدي هذا الإجراء إلى حذف الشعبة نهائيًا من المرجع. ستفقد المجموعات المرتبطة انتمائها.',
            },
            salles: {
                title: 'القاعات',
                subtitle: 'إدارة الممتلكات العقارية وفضاءات التكوين',
                search_placeholder: 'البحث عن قاعة...',
                add_button: 'إضافة قاعة',
                new_room: 'فضاء جديد',
                register_room: 'تسجيل قاعة',
                available: 'القاعة متاحة',
                update_room: 'تحديث الفضاء',
                label: 'اسم القاعة',
                placeholder: 'أدخل اسم القاعة...',
                save: 'حفظ',
                no_rooms: 'لم يتم العثور على أي قاعة',
                modal_new: 'قاعة جديدة',
                modal_edit: 'تعديل القاعة',
                modal_admin: 'إدارة المحلات',
                modal_label: 'الاسم الرسمي للقاعة',
                modal_placeholder: 'أدخل اسم القاعة...',
                modal_save: 'حفظ القاعة',
                modal_update: 'تحديث القاعة',
            },
            absence_registry: {
                title: "سجل الغياب",
                subtitle: "الإدارة التأديبية والتبريرات",
                search: "بحث...",
                filter_status: "جميع الحالات",
                filter_absences: "الغيابات",
                filter_lates: "التأخرات",
                filter_presences: "الحضور",
                filter_all_justif: "جميع التبريرات",
                filter_justified: "مبررة",
                filter_not_justified: "غير مبررة",
                filter_pending: "في الانتظار",
                col_student: "المتدرب",
                col_session: "الحصة / التاريخ",
                col_status: "الحالة",
                col_reported_by: "تم التبليغ بواسطة",
                col_actions: "إجراءات",
                btn_justify: "تبرير",
                btn_cancel_justif: "إلغاء التبرير",
                btn_sanction: "معاقبة",
                status_absence: "غياب",
                status_late: "تأخر",
                status_present: "حاضر",
                status_justified: "مبرر",
                status_not_justified: "غير مبرر",
                sync: "جاري مزامنة السجل...",
                delete_title: "حذف حرج",
                delete_msg: "سيؤدي هذا الإجراء إلى حذف الشعبة نهائيًا من المرجع.",
                sync_error: "خطأ أثناء جلب السجل",
                justif_success: "تم تبرير الغياب بنجاح",
                justif_removed: "تم سحب التبرير",
            ...
            profile: {
                ...
                error_msg: "خطأ أثناء التحديث",
                password_match_error: "كلمات المرور الجديدة غير متطابقة",
                password_subtitle: "عزز حماية وصولك",
                password_hint: "يوصى باستخدام 8 أحرف على الأقل",
                sync: "جاري التحديث...",
            },
            header: {
            ...
            accounts: {
                ...
                header_title: 'الحسابات',
                header_subtitle: 'إدارة مستخدمي ISTA',
                all_streams: 'جميع الشعب',
                add_user: 'إضافة مستخدم',
                add_member: 'إضافة عضو',
                stream_label: 'الشعبة',
                search_placeholder: 'البحث عن متدرب (الاسم، المعرف، البريد الإلكتروني)...',
                search_stg_placeholder: 'البحث عن اسم أو معرف...',
                search_staff_placeholder: 'البحث عن الموظفين...',
                total_students: 'المتدربون المسجلون',
                students_section: 'المتدربون',
                students_list: 'قائمة المتدربين',
                formateurs_section: 'المكونون',
                formateurs_team: 'الفريق البيداغوجي والموظفون',
                col_id: 'المعرف',
                col_name: 'الاسم الكامل',
                col_filiere: 'الشعبة',
                col_group: 'المجموعة',
                col_groups: 'المجموعات',
                col_email: 'البريد الإلكتروني',
                col_status: 'الحالة',
                status_online: 'متصل',
                status_offline: 'غير متصل',
                no_students_found: 'لم يتم العثور على أي متدرب',
                no_staff_found: 'لم يتم العثور على أي موظف',
            ...
            reports: {
                ...
                absent_label: 'غائبون',
                export_subtitle: 'نموذج احترافي (نسخة حديثة)',
                export_salle: 'القاعة',
                export_time: 'الوقت',
                export_total: 'المجموع',
                export_absents_count: 'الغياب',
                export_num: 'رقم',
                export_btn: 'تصدير',
            ...
            penalty_decision: {
                degree: 'الدرجة {{num}}',
                blame_simple: 'توبيخ بسيط',
                mise_a_pied: 'توقيف',
                exclusion: 'فصل',
                procedure: 'إجراء تأديبي',
                status: 'الحالة',
                unjustified: 'غياب غير مبرر',
                incident_context: 'سياق الحادثة',
                group: 'المجموعة',
                module: 'الوحدة',
                session: 'الحصة',
                date: 'التاريخ',
                history: 'السوابق',
                absences: 'الغيابات',
                sanctions_count: 'العقوبات',
                select_sanction: 'اختيار العقوبة',
                reason_report: 'السبب / التقرير',
                reason_placeholder: 'قم بتفصيل الأسباب هنا...',
                validate: 'تأكيد العقوبة'
            },
            datepicker: {
